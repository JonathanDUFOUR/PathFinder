...
/*   Updated: 2021/04/14 19:47:12 by jodufour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	start_color();
	init_pair(START_COLOR, COLOR_YELLOW, COLOR_YELLOW);
	...
	init_pair(PATH_COLOR, COLOR_RED, COLOR_BLACK);
	init_pair(FIND_COLOR, COLOR_CYAN, COLOR_BLACK);
